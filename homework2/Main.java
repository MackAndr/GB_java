...
//    Параметры для фильтрации: {"name":"Ivanov", "country":"Russia", "city":"Moscow", "age":"null"}
    ...
    public static void Task1() throws JSONException {
        JSONObject client = new JSONObject("{\"name\":\"Ivanov\", \"country\":\"Russia\", \"city\":\"Moscow\", \"age\":\"null\"}");
        String name = (String) client.get("name");
        String country = (String) client.get("country");
...
//    Студент Краснов получил 5 по предмету Физика.
    public static void Task3() throws JSONException {
